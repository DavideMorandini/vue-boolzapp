  ...
  data() {
    return {
        ...
        botAnswers: [
            ...
            {
                date: new Date().toLocaleString('it-IT'),
                message: 'Onestamente, non lo so',
                status: 'received',
                showMenu: false,
            },
            {
                date: new Date().toLocaleString('it-IT'),
                message: 'Penso che la risposa sia sempre la stessa',
                status: 'received',
                showMenu: false,
            },
            {
                date: new Date().toLocaleString('it-IT'),
                message: 'Ma se facessimo una partita online?',
                status: 'received',
                showMenu: false,
            },
            {
                date: new Date().toLocaleString('it-IT'),
                message: 'Tu che cosa gli hai detto?',
                status: 'received',
                showMenu: false,
            },
            {
                date: new Date().toLocaleString('it-IT'),
                message: 'Così su due piedi non so cosa dirti',
                status: 'received',
                showMenu: false,
            },
            {
            ...
            {
                date: new Date().toLocaleString('it-IT'),
                message: 'Questo è il mio pensiero',
                status: 'received',
                showMenu: false,
            },
            {
